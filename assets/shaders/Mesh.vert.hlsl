...
VSOutput main(uint vertexIndex : SV_VertexID)
{
    ...
    float4 position = asfloat(GeometryVertices.Load4(vertexByteOffset + POSITION_COLOR_POSITION_OFFSET_BYTES));
    float4 color = asfloat(GeometryVertices.Load4(vertexByteOffset + POSITION_COLOR_COLOR_OFFSET_BYTES));
